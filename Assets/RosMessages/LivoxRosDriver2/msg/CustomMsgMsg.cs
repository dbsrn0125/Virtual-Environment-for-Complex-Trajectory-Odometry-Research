...
namespace RosMessageTypes.LivoxRosDriver2
{
    [Serializable]
    public class CustomMsgMsg : Message
    {
        public const string k_RosMessageName = "livox_ros_driver2/CustomMsg";
        ...
        public CustomMsgMsg(Std.HeaderMsg header, ulong timebase, uint point_num, byte lidar_id, byte[] rsvd, CustomPointMsg[] points)
        {
            this.header = header;
